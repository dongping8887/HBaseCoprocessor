...
module Hbase
  class Admin
    ...
    def add_global_index(tableName,indexName,desc)
      @add_global_index = com.netposa.dw.index.AddIndex.new()
      return @add_global_index.addGlobalIndex(tableName,indexName,desc)
    end

    def add_fulltext_index(tableName,indexName,desc)
      @add_fulltext_index = com.netposa.dw.index.AddIndex.new()
      return @add_fulltext_index.addFulltextIndex(tableName,indexName,desc)
    end

    def rebuild_global_index(tableName,indexName)
      @rebuild_global_index = com.netposa.dw.index.AddIndex.new()
      return @rebuild_global_index.rebuildGlobalIndex(tableName,indexName)
    end

    def rebuild_fulltext_index(tableName,indexName)
      @rebuild_fulltext_index = com.netposa.dw.index.AddIndex.new()
      return @rebuild_fulltext_index.rebuildFulltextIndex(tableName,indexName)
    end
    
    def delete_global_index(tableName,indexName)
      @delete_global_index = com.netposa.dw.index.AddIndex.new()
      return @delete_global_index.deleteGlobalIndex(tableName,indexName)
    end

    def delete_fulltext_index(tableName,indexName)
      @delete_fulltext_index = com.netposa.dw.index.AddIndex.new()
      return @delete_fulltext_index.deleteFulltextIndex(tableName,indexName)
    end
