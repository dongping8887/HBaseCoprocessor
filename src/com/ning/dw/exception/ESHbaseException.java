 ...
 * 
  ...
  * @Description: TODO
  * @author ningyexin
  * @date 2016年5月17日 下午4:23:39
  *
 */
public class ESHbaseException extends Exception {
    ...
    public ESHbaseException()
    {  
        super();
    }
    
    private ESHbaseException(String finalMsg)
    {  
        super(finalMsg);
    }
    
    public static ESHbaseException throwException(String msg,String... params)
    {  
        
        String finalMsg = buildMsg(msg, params);
        return new ESHbaseException(finalMsg);
    }
